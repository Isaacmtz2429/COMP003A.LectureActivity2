...
// Purpose: A program demonstrating statements, variables, and operations. 
*/
namespace COMP003A.LectureActivity2
{
    internal class Program
    {
        ...
        {
            // Step 3.1 Declare and initialize vatiables
            string userName; // Variable to store the user's name
            int userAge; // Variable to store the user's age
            double productPrice; // Variable to store the product priv
